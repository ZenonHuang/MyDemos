...
//  gosparkchat
//
//  Created by ZernonHuang on 2016/12/27.
//  Copyright © 2016年 gospark. All rights reserved.
//

#import "HZAdAOP.h"

@interface HZAdAOP () <IMYAOPTableViewDelegate, IMYAOPTableViewDataSource>

@end
@implementation HZAdAOP
...
//    }
    ...
    IMYAOPTableViewInsertBody *body=[IMYAOPTableViewInsertBody insertBodyWithSection:0];
    [insertBodys addObject:body];
    ...
    [insertBodys enumerateObjectsUsingBlock:^(IMYAOPTableViewInsertBody * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        obj.indexPath = [NSIndexPath indexPathForRow:3 inSection:obj.resultSection];
    }];
    [self.aopUtils insertWithIndexPaths:insertBodys];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(cell.contentView.subviews.count == 0) {
        ...
        imageView.image = [UIImage imageNamed:@"find_img_empty"];
...
{
    UIAlertView* alertView = [[UIAlertView alloc] initWithTitle:@"被点击了> <"
                                                        message:[NSString stringWithFormat:@"我的位置: %@",indexPath]
                                                       delegate:nil
                                              cancelButtonTitle:@"哦~滚"
