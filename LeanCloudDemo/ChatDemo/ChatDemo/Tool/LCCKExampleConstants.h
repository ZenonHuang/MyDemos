...
#define LCCKContactProfiles                                                                        \
    @[                                                                                             \
       @{                                                                                          \
          LCCKProfileKeyPeerId : LCCKDeveloperPeerId,                                              \
          LCCKProfileKeyName : @"ChatKit-iOS小秘书",                                               \
          LCCKProfileKeyAvatarURL : @"http://image17-c.poco.cn/mypoco/myphoto/20151211/16/"        \
                                    @"17338872420151211164742047.png"                              \
       },                                                                                          \
       @{                                                                                          \
          LCCKProfileKeyPeerId : @"Tom",                                                           \
          LCCKProfileKeyName : @"Tom",                                                             \
          LCCKProfileKeyAvatarURL : @"http://www.avatarsdb.com/avatars/tom_and_jerry2.jpg"         \
       },                                                                                          \
       @{                                                                                          \
          LCCKProfileKeyPeerId : @"Jerry",                                                         \
          LCCKProfileKeyName : @"Jerry",                                                           \
          LCCKProfileKeyAvatarURL : @"http://www.avatarsdb.com/avatars/jerry.jpg"                  \
       },                                                                                          \
       @{                                                                                          \
          LCCKProfileKeyPeerId : @"Harry",                                                         \
          LCCKProfileKeyName : @"Harry",                                                           \
          LCCKProfileKeyAvatarURL : @"http://www.avatarsdb.com/avatars/young_harry.jpg"            \
       },                                                                                          \
       @{                                                                                          \
          LCCKProfileKeyPeerId : @"William",                                                       \
          LCCKProfileKeyName : @"William",                                                         \
          LCCKProfileKeyAvatarURL : @"http://www.avatarsdb.com/avatars/william_shakespeare.jpg"    \
       },                                                                                          \
       @{                                                                                          \
          LCCKProfileKeyPeerId : @"Bob",                                                           \
          LCCKProfileKeyName : @"Bob",                                                             \
          LCCKProfileKeyAvatarURL : @"http://www.avatarsdb.com/avatars/bath_bob.jpg"               \
       },                                                                                          \
    ]

#define LCCKContactPeerIds [LCCKContactProfiles valueForKeyPath:LCCKProfileKeyPeerId]
...
#define LCCKTestPeerIds [LCCKTestPersonProfiles valueForKeyPath:LCCKProfileKeyPeerId]
