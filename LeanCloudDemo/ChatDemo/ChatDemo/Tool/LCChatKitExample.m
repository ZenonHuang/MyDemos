 ...
 *  @param aNavigationController 根视图控制器
 */
...
+ (void)signOutFromViewController:(UIViewController *)viewController
{
    ...
    [LCChatKitExample invokeThisMethodBeforeLogoutSuccess:^{
      ...
      //      LCCKLoginViewController *loginViewController = [[LCCKLoginViewController alloc]
      //      init];
      ...
      //          }];
      //      }];
      //      [viewController presentViewController:loginViewController animated:YES
      //      completion:nil];
    }
        failed:^(NSError *error) {
          [LCCKUtil hideProgress];
